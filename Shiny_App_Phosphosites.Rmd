...
load_data <- function(page) {
  if (page == "page1") {
    list(
      ...
      score_table = read.csv(url("https://raw.githubusercontent.com/WidmerAndri/msa_files/refs/heads/main/scoring_table_final_neu.csv"), sep = ";"),
    ...
    list(
      ...
      score_table = read.csv(url("https://raw.githubusercontent.com/WidmerAndri/msa_files/main/scoring_table_SC_AT.csv"), sep = ";"),
    ...
    list(
      ...
      score_table = read.csv(url("https://raw.githubusercontent.com/WidmerAndri/msa_files/main/scoring_table_SC_HS.csv"), sep = ";"),
...
<hr>
Using the filter and search features takes quite some time for proper loading. Please be patient;)
<hr>
...
<ul>
  <li><b>t<sub>x</sub></b>: Normalized entropy (sequence variability)</li>
...
<ul>
  <li><b>t<sub>x</sub></b>: Sequence variability (entropy)</li>
